...
from dmanip.utils.torch_utils import to_torch
...
class Environment:
    ...
    def init(self):
        ...
        try:
            ...
            builder.num_rigid_contacts_per_env = self.asset_builders[0].num_rigid_contacts_per_env
        ...
        if self.render_mode == RenderMode.OPENGL:
            ...
            print("rendering USD to", filename)
