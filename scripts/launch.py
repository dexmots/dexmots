...
from dmanip.utils import slurm
from dmanip.utils.slurm import random_string, try_parse, yes_no_prompt
...
if __name__ == "__main__":
    ...
    )  # shorthand for --sbatch gres gpu:1
